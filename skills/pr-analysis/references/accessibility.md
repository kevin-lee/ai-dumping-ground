...
- Theme colors keep every text pair at 4.5:1 or more in light and dark, syntax colors included on the CVD row tints, and `check.mjs` fails the page otherwise (template).
